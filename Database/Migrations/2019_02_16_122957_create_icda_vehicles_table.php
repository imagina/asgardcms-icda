...
class CreateIcdaVehiclesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('icda__vehicles', function (Blueprint $table) {
            ...
            $table->date('tecnomecanica_expiration')->nullable();//fecha expedición seguro
            $table->date('tecnomecanica_expedition')->nullable();//fecha vencimiento seguro
            $table->string('tecnomecanica_code')->nullable();//código tecnomecánica
            $table->timestamps();
        });
    }
