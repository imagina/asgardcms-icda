...
@section('content-header')
    <h1>
        {{ trans('icda::vehicles.title.edit vehicles') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.icda.vehicles.index') }}">{{ trans('icda::vehicles.title.vehicles') }}</a></li>
        <li class="active">{{ trans('icda::vehicles.title.edit vehicles') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.icda.vehicles.update', $vehicles->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
